...
function addItem(value){var caseInSensitiveFound=false;if(!caseSensitive){$.each(inserted,function(index,val){if(caseInSensitiveFound==false&&(val.toLowerCase()==value.toLowerCase())){caseInSensitiveFound=true;return true;}});}
