...
suggestList.css('display','none');updateTagInputWidth();tagInput.focus();setValue();if((allowedTagsNumber!=false)&&(inserted.length>=allowedTagsNumber)){disableAddItem()}}
